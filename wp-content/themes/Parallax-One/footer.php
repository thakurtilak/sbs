 ...
 */ ?>
<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer black-bg">
	<div class="container">
								...
								<li>
									...
									?>
											<a target="_blank" href="<?php echo esc_url( $link ); ?>">
												<span class="fa parallax-one-footer-icons <?php echo esc_attr( $icon ); ?>"></span>
											</a>
									<?php
									} else {
									?>
	...
	?>
		...
		<?php echo apply_filters( 'parallax_one_plus_footer_text_filter','<div class="powered-by">&copy;'.Date("Y").' All Rights Reserved. Designed & Managed by Dharmendra thakur.</div>' ); ?>
	</div><!-- container -->
</footer>
