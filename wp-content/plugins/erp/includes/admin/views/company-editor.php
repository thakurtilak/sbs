<div class="wrap erp erp-company-single">
    <h2><?php _e( 'School', 'erp' ); ?></h2>

    <?php if ( isset( $_GET['msg'] ) && $_GET['msg'] == 'updated' ) { ?>
        <div class="updated">
            <p><?php _e( 'School information has been updated!', 'erp' ); ?></p>
        </div>
    <?php } else if ( isset( $_GET['msg'] ) && $_GET['msg'] == 'error' ) { ?>
        <?php
            if ( ! empty( $_GET['error-company'] ) ) {
                $errors[] = __( 'School name is required', 'erp' );
            }
        ...
        <div class="erp-single-container">
            <div class="erp-area-left">
                ...
                <div class="postbox company-postbox">
                    <h3 class="hndle"><span><?php _e( 'School Information', 'erp' ); ?></span></h3>
                    <div class="inside">
            ...
            <div class="erp-area-right">
                <div class="postbox company-logo" id="postimagediv">
                    <h3 class="hndle"><span><?php _e( 'School Logo', 'erp' ); ?></span></h3>
                    <div class="inside">
                        ...
                        <?php if ( $company->has_logo() ) { ?>
                            ...
                            <p class="hide-if-no-js">
                                ...
                                <a href="#" class="remove-logo"><?php _e( 'Remove School logo', 'erp' ); ?></a>
                            </p>

                        <?php } else { ?>

                            <p class="hide-if-no-js">
                                <a href="<?php echo get_upload_iframe_src('image' ); ?>" id="set-company-thumbnail" class="thickbox"><?php _e( 'Upload School logo', 'erp' ); ?></a>
                            </p>
                        ...
                        <div class="submitbox" id="submitbox">
                            <div id="major-publishing-actions">
                                ...
                                <div id="publishing-action">
                                    ...
                                    <input name="save" type="submit" class="button button-primary button-large" id="publish" accesskey="p" value="<?php echo __( 'Update School', 'erp' ); ?>">
                                </div>
